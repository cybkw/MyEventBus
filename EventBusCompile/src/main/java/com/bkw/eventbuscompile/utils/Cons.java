...
public class Cons {
     ...
     * 注解处理器中支持的注解类型
     */
    public static final String SUBSCRIBE_ANNOTATION_TYPES = "com.bkw.eventbusannotation.annotation.Subscribe";
     ...
     * 所有的事件订阅方法，生成索引接口
     */
    public static final String SUBSCRIBERINFO_INDEX = "com.bkw.eventbusannotation.SubscriberInfoIndex";
